...
const translations = {
  tr: {
    ...
    bentoProvidersTitle: "🌐 3 Katmanlı Esnek Model Mimarisi: Yerel, Self-Hosted & Bulut Sağlayıcılar",
    bentoProvidersDesc: "Sıfır bağımlılık: Donanımınızda %100 çevrimdışı çalışın, kendi yerel Ollama/vLLM sunucunuzu bağlayın veya kendi API anahtarınızla (BYOK) en güçlü bulut modellerini DLP korumasıyla kullanın.",
    tier1Title: "💻 %100 Yerel (Bare-Metal)",
    tier1Desc: "Apple Metal GPU & NVIDIA CUDA ile Whisper.cpp çevrimdışı transkripsiyon. Sıfır bulut, sıfır abonelik.",
    tier2Title: "🏠 Kendi LLM Sunucun (Ollama)",
    tier2Desc: "Yerel ağınızdaki Ollama, vLLM, LocalAI veya OpenAI-uyumlu sunucuları tek tıkla entegre edin.",
    tier3Title: "☁️ Genel Sağlayıcılar (BYOK)",
    tier3Desc: "Kendi API anahtarınızla OpenAI, Google Gemini ve Groq modelleri. İstemci taraflı DLP ile sansürlenir.",
  ...
  en: {
    ...
    bentoProvidersTitle: "🌐 3-Tier Flexible Model Architecture: Local, Self-Hosted & Cloud",
    bentoProvidersDesc: "Zero vendor lock-in: Run 100% offline on bare-metal hardware, connect your local Ollama/vLLM server, or bring your own API keys (BYOK) for top cloud models protected by client-side DLP.",
    tier1Title: "💻 100% Local (Bare-Metal)",
    tier1Desc: "Whisper.cpp offline transcription accelerated by Apple Metal GPU & NVIDIA CUDA. Zero cloud, zero subscription.",
    tier2Title: "🏠 Self-Hosted LLMs (Ollama)",
    tier2Desc: "Seamlessly connect local Ollama, vLLM, LocalAI, or custom OpenAI-compatible servers on your LAN.",
    tier3Title: "☁️ Public Cloud (BYOK)",
    tier3Desc: "Use OpenAI, Google Gemini, and Groq with your own API keys. All data is client-side redacted before sending.",
    ...
    linuxDistroDesc: "Native packages for Ubuntu, Debian, Fedora, and Arch x64.",
