...
const translations = {
  tr: {
    ...
    bentoProvidersDesc: "Sıfır bağımlılık: Donanımınızda %100 çevrimdışı çalışın, kendi yerel Ollama/vLLM sunucunuzu bağlayın veya kendi API anahtarınızla en güçlü bulut modellerini aracı komisyonsuz ve DLP korumasıyla kullanın.",
    ...
    tier3Desc: "Abonelik ödemeden kendi API anahtarınızla OpenAI, Google Gemini ve Groq. İstemci taraflı DLP ile sansürlenir.",
  ...
  en: {
    ...
    tier3Desc: "Use OpenAI, Google Gemini, and Groq with your own API keys (no middleman fees). All data is client-side redacted before sending.",
