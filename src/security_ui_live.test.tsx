...
describe('Live UI Security & Adversarial Injection Suite', () => {
  it('1. Credential Vault: Password masking & no plaintext secrets exposed in DOM attributes', async () => {
    ...
    const apiTabBtn = screen.getByRole('button', { name: /Yapay Zeka Servisleri/i });
  ...
  it('3. DLP Live Redaction in User Input & Feed', () => {
    const rawUserInput = 'Toplantı notu: CEO kartı 4532 0151 1283 0366 ve TCKN 10000000146, API: sk-proj-1234567890abcdef1234567890abcdef';
