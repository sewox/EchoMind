...
export const tr: TranslationKeys = {
  ...
  transcript: {
    ...
    analytics: {
      ...
      pace: "Toplantı Hızı",
      wpm: "Kelime/Dk (WPM)",
      dominantSpeaker: "En Çok Konuşan Katılımcı",
      speakerStatsTitle: "Katılımcı Konuşma Dağılımı",
      insightsTitle: "Akıllı Toplantı İçgörüleri",
      longestMonologue: "En Uzun Monolog",
      segments: "Konuşma Bloğu",
      close: "Kapat",
    },
  ...
  updater: {
    ...
    upToDateDesc: "En güncel EchoMind sürümünü kullanıyorsunuz ({version}).",
  ...
  followUp: {
    ...
    tabs: {
      email: "📧 Takip E-Postası",
      actions: "✅ Görevler & Sorumlular",
      calendar: "📅 Takvim Daveti (.ics)",
      slack: "💬 Slack & Teams",
    },
    tones: {
      standard: "Standart / Dengeli",
      executive: "Yönetici / C-Level",
      sales: "Müşteri / Satış",
      casual: "Samimi / Ekip İçi",
    },
    toneLabel: "E-Posta İletişim Tonu:",
    emailSubject: "E-Posta Konusu",
    emailBody: "E-Posta Gövdesi",
    openInMailClient: "E-Posta İstemcisinde Aç (Mail / Outlook)",
    copyEmail: "E-Postayı Kopyala",
    copySubject: "Konuyu Kopyala",
    copyBody: "Metni Kopyala",
    actionItemsTitle: "Aksiyon Maddeleri ve Görev Listesi",
    actionItemsEmpty:
      "Bu toplantıda tespit edilmiş açık eylem maddesi bulunamadı.",
    copyActionMarkdown: "Markdown Görevleri Kopyala",
    copyActionCsv: "CSV Olarak Kopyala",
    calendarTitle: "Takip Toplantısı Takvim Daveti (.ics)",
    calendarDesc:
      "Apple Calendar, Google Calendar ve Outlook ile uyumlu .ics takvim etkinlik dosyası.",
    meetingTitleLabel: "Etkinlik Başlığı:",
    eventDateLabel: "Takip Tarihi & Saati:",
    eventDurationLabel: "Süre (Dakika):",
    downloadIcs: ".ics Takvim Dosyasını İndir",
    slackTitle: "Slack & Microsoft Teams Biçimlendirilmiş Özet",
    copySlack: "Slack Formatında Kopyala",
  ...
  tags: {
    ...
    allTags: "Tümü",
    addTag: "Etiket Ekle",
    addTagPlaceholder: "Yeni etiket adı...",
    removeTag: "Etiketi Kaldır",
    autoTaggedBadge: "Otomatik Etiketlendi",
    ...
    hr: "İnsan Kaynakları & İşe Alım",
    sprint: "Sprint & Operasyon",
    general: "Genel Değerlendirme",
  },
  relatedMeetings: {
    title: "İlgili Geçmiş Toplantılar",
    subtitle:
      "Mevcut toplantıyla anlamsal, etiket ve konu bağı olan geçmiş görüşmeler",
    viewMeeting: "Toplantıyı İncele",
    similarityScore: "Benzerlik",
    sharedTags: "Ortak Etiketler",
    sharedParticipants: "Ortak Katılımcılar",
    noRelatedMeetings: "İlgili geçmiş toplantı bulunamadı",
